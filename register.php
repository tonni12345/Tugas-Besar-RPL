...
<html lang="en">
    <head>
        ...
        <title>Registrasi Ke Resto</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Register Resto</h3></div>
                                    <div class="card-body">
                                        <?php 
                                            if(isset($_POST['register'])){
                                                ...
                                                $posisi = $_POST['posisi'];
                                                 ...
                                                 $insert = mysqli_query($koneksi, "INSERT INTO pegawai(nama_pegawai, username, password, no_telp, alamat, posisi) VALUES('$nama', '$username', '$password', '$no_telepon', '$alamat', '$posisi')");
