...
<h1 class="mt-4">Daftar Pesanan Yang Belum Dibayar</h1>
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-striped table-bordered text-center" id="dataTable" width="100%" cellspacing="5">
                ...
                WHERE pesanan.status = 'Selesai' AND pesanan.status_pembayaran = 'belum bayar'");
                while($data = mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="cetak_per_1.php?id=<?php echo $data['id_pesanan']; ?>" class="btn btn-info btn-sm">Cetak</a>   
                        </td>
                    </tr>
                    <?php
                }
